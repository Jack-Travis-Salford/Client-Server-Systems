...
$view->currentPage = 'friend_Requests.php'; //Holds current page. Can be used by forms that POST to a different page, but want to return to current page afterward.
...
if(isset($_SESSION['uID'])) {
    require_once('Models/User_Friend_Requests.php');
    $user_Friends = new User_Friend_Requests(); //Gets users for front page
...
require_once('Views/friend_Requests.phtml');