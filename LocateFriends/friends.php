...
$view->currentPage = 'friends.php'; //Holds current page. Can be used by forms that POST to a different page, but want to return to current page afterward.
...
if(isset($_SESSION['uID'])) {
    require_once('Models/User_Friends.php');
    $user_Friends = new User_Friends(); //Gets users for front page
