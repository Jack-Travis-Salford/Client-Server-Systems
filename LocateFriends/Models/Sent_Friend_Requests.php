...
class Sent_Friend_Requests {
    ...
    public function fetchSome($pageNo, $uID)
    {
        ...
        $sqlQuery = 'SELECT Users.userID, Users.username, Users.first_name, Users.surname FROM Users, Friends WHERE (Users.userID = Friends.user1 and Friends.user2 ='.$uID.' and friendCode=2) or (Users.userID = Friends.user2 and Friends.user1= '.$uID.' and friendCode = 1) LIMIT 25 OFFSET '.$offset;
        ...
        $sqlQuery = 'SELECT COUNT(user1User2) FROM Friends WHERE (user1='.$uID.' and friendCode = 1) or (user2='.$uID.' and friendCode = 2) '; //Counts total users than matched SQL
